...
const writeTestCases1 = [
  { name: 'first', args: [5, 0], expected: 5 },
  { name: 'second', args: [-3, 8], expected: 5 },
  ...
  { name: 'fifth', args: [1e5, -99999], expected: 1 }, // create your own test case!
  { name: 'sixth', args: [5, 5], expected: 10 }, // create your own test case!
];
...
const writeTestCases2 = [
  ...
  { name: 'second', args: [-10, -15], expected: 5 },
  ...
  { name: 'fifth', args: [15, -985], expected: 1e3 }, // create your own test case!
  { name: 'sixth', args: [2, 2], expected: 0 }, // create your own test case!
];
...
const writeTestCases3 = [
  { name: 'first', args: [10, 0.5], expected: 5 },
  ...
  { name: 'fifth', args: [2, 0.123], expected: 0.246 }, // create your own test case!
  { name: 'sixth', args: [1e17, 0], expected: 0 }, // create your own test case!
];
...
const writeTestCases5 = [
  ...
  { name: 'fifth', args: [1, 2, 3], expected: 6 }, // create your own test case!
  { name: 'sixth', args: [`a`, `Ma`, `sh`], expected: `Masha` }, // create your own test case!
];
