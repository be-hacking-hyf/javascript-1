...
const StringTests = [
  ...
  { name: 'str, any string', args: ['any string'], expected:'String'  },
  // casting with String just puts quotes around a thing
  { name: 'num, 3', args: [3], expected: Number },
  ...
  { name: 'Meryem, Sener', arg: [Meryem], expected: 'String' },
  { name: 'Meryem, Sener', arg: [Meryem], expected: 'String' },
  { name: 'Meryem, Sener', arg: [Meryem], expected: 'String' },
  { name: 'Meryem, Sener', arg: [Meryem], expected: 'String' },
  { name: 'Meryem, Sener', arg: [Meryem], expected: 'String' },
...
const NumberTests = [
  ...
  { name: 'num, 1e3', args: [1000], expected: Number },
  ...
  { name: 'str, Infinity', args: ['Infinity'], expected: 'string' },
  { name: 'str, three', args: ['three'], expected: 'string' },
